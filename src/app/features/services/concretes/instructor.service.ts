...
import { DeleteInstructorRequest } from "../../models/requests/instructor/delete-instructor-request";
...
export class InstructorService extends InstructorBaseService {
  ...
  private readonly apiUrlRegister: string = `${environment.API_URL}/Auth/RegisterInstructor`;
